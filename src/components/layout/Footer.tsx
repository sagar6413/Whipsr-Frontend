        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <MessageSquare className="w-6 h-6 text-[#6200EA]" />
              <h3 className="text-xl font-montserrat font-bold bg-gradient-to-r from-[#6200EA]to-[#00BFA5] bg-clip-text text-transparent">
                Whispr
              </h3>
            </div>
            <p className="text-gray-400 text-sm">
              Private, temporary conversations for those who value discretion and authentic connection.
            </p>
          </div>
